...
class Sidebar extends App {
    ...
    render() {
        ...
        const componentLinks = [
            ...
            { href: '/docs/components/collapse', label: 'Collapse' },
            ...
            { href: '/docs/components/error-message', label: 'Error Message' },
            ...
            { href: '/docs/components/hero', label: 'Hero Section' },
            ...
            { href: '/docs/components/loader', label: 'Loader' },
            ...
            { href: '/docs/components/snackbar', label: 'Snackbar' },
            ...
            { href: '/docs/components/upload-button', label: 'Upload Button' },
            { href: '/docs/components/user-profile', label: 'User Profile Card' },
